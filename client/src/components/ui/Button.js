...
const Button = ({
  ...
  const variantClasses = {
    ...
    accent: 'bg-accent text-secondary-dark hover:bg-accent-dark focus:ring-accent active:bg-accent-dark',
    ...
    >
      ...
      {loading && (
        <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 block w-4 h-4">
          <svg className="animate-spin" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none">
